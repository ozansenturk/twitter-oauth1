...
list_followers = 'https://api.twitter.com/1.1/followers/list.json'
oauth_store = {}
...
def start():
    ...
    app_callback_url = current_app.config['CALL_BACK_URL']
    ...
    #TODO oauth_token and oauth_store are essentials
...
def callback():
    ...
    # TODO save them safe place
    real_oauth_token = access_token[b'oauth_token'].decode('utf-8')
    real_oauth_token_secret = access_token[b'oauth_token_secret'].decode(
        'utf-8')
    user_credentials["real_oauth_token"] = real_oauth_token
    user_credentials["real_oauth_token_secret"] = real_oauth_token_secret

    # Call api.twitter.com/1.1/users/show.json?user_id={user_id}
    real_token = oauth.Token(real_oauth_token, real_oauth_token_secret)
    user_credentials["real_token"] = real_token
